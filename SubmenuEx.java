...
public class SubmenuEx extends JFrame {
    ...
    private void createMenuBar() {
        ...
        var iconNew = new ImageIcon("./models/new.png");
        var iconOpen = new ImageIcon("./models/open.png");
        var iconSave = new ImageIcon("./models/save.png");
        var iconExit = new ImageIcon("./models/exit.png");
